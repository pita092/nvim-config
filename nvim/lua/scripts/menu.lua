...
local function CreateDashboard()
  ...
  set_keymap('e', ':lua require("scripts.menu").new_file()<CR>')
  set_keymap('f', ':lua require("scripts.menu").telescope_findfiles()<CR>')
  set_keymap('r', ':lua require("scripts.menu").telescope_oldfiles_in_new_tab()<CR>')
